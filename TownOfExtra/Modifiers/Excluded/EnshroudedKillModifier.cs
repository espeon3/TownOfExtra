...
public sealed class EnshroudedKillModifier : ConcealedModifier, IVisualAppearance
{
    public override string ModifierName => "Invisible";
    public override float Duration => OptionGroupSingleton<ShadowWalkerRoleOptions>.Instance.InvisDurOnKill;
    public override LoadableAsset<Sprite> ModifierIcon => TownOfExtraAssets.ShadowWalkerEnshroudButton;
    ...
    public override void OnActivate()
    {
        if (Player.AmOwner)
        {
            ...
            if (OptionGroupSingleton<ShadowWalkerRoleOptions>.Instance.SpeedMultiOnRegKill)
            {
